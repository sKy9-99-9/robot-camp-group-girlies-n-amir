...
def act1_alissa():
    ...
    return (
        ...
        f"Whilst looking for {char_laur()} they bumped into {char_amr()}, who was picking a fight with Larky Lark by the fountain for simply breathing in his presence. "
...
def act2_alissa():
    ...
    return (
        ...
        f"{char_pix()} curled up near the base, watching the others silently, her small presence somehow calming. "
...
def act3_alissa():
    ...
    return (
        ...
        f"{char_laur()} took a deep breath, feeling a strange mixture of relief and excitement. "
