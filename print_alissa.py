...
def act1_alissa():
    ...
    return (
        ...
        f"{char_laur()} had been having more and more outbursts recently. Something was cleerly wrong with {char_laur()} and they needed to figure out what and why. "
...
def act2_alissa():
    ...
    return (
        ...
        f"{char_ali()} sat beside {char_laur()}, gently placing a hand on his shoulder. {char_mati()} knelt on the other side, murmuring comforting words, making the mushroom feel like a safe little hideawy. "
...
def act3_alissa():
    ...
    return (
        ...
        "They paused at Clover Crescent Str., looking back at the mushroom where their adventures had begun and smild. "
