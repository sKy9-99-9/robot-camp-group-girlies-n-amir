...
def act1_laura():
    ...
    return (
        ...
        f"{char_laur()} hatted his life. He hated his 9-5. He did not get paid enough for this. It was your typical Monday and he had a full list of client appointments. "
        f"Today, he was boooked to meet with {char_pix()} from 8-10, {char_ali()} at 10:15, {char_amr()} at 12 and {char_mati()} at 15 to round it all off."
    )
...
def act2_laura():
    ...
    return (
        ...
        "Was he under the Magic McRonalds? No. Was he at Burger Queen? No. There weren’t many other loquations that "
        f"{char_laur()} frequented, so they made their way towards the divorce lawyer’s office. There they found {char_laur()}, crying under a magic mshrom. "
...
def act3_laura():
    ...
    from print_mathilde import char_mati
    return (
        f"{char_ali()} and {char_mati()} helpped {char_laur()} up. “C’mon, let’s get you out there! It’s time for a Girl’s Night!!” "
        f"{char_amr()} nudged {char_laur()} forward with his head encouragingly as they made their way towards {char_pix()}’s toadstool. "
        "They entered and were greted by a warm ambiance and the smell of freshly baked bread. "
